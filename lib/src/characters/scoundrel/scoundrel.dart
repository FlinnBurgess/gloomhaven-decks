...
class Scoundrel extends Character {
  ...
  Scoundrel(this.name) {
    perks = [
      ...
      Perk.replaceCards([DamageChangeCard.minusOne()], [DamageChangeCard.plusOne()], Perk.ONE_PERK_AVAILABLE, 'Replace one -1 card with one +1 card'),
      Perk.replaceCards([DamageChangeCard.zero()], [DamageChangeCard.plusTwo()], Perk.TWO_PERKS_AVAILABLE, 'Replace one +0 card with one +2 card'),
