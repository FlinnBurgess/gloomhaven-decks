      ...
      SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                  height: 350,
                  child: unequippedItems.isNotEmpty
                      ? ListView.builder(
                          primary: false,
                          shrinkWrap: true,
                          physics: ClampingScrollPhysics(),
                                    ...
                                    children: [
                                      ...
                                      RaisedButton(
                                        onPressed: () => setState(() {
                                          ...
                                          if (unequippedItems[index]
                                              .isMultiUse) {
                                            unequippedItems[index].timesUsed =
                                                0;
                                          }
                                          unequippedItems[index].used = false;
                                          unequippedItems[index].equipped =
                                              true;
                                        }),
                                        child: Text(
                                          "Equip",
